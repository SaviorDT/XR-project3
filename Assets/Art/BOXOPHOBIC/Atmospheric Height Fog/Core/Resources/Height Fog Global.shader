	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_7_0_g1000 = AHF_FogDistanceStart;
				float temp_output_155_0_g994 = saturate( ( ( distance( WorldPosition2_g994 , _WorldSpaceCameraPos ) - temp_output_7_0_g1000 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1000 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g994 = temp_output_155_0_g994;
				#else
				float staticSwitch467_g994 = pow( abs( temp_output_155_0_g994 ) , AHF_FogDistanceFalloff );
				#endif
				half FogDistanceMask12_g994 = staticSwitch467_g994;
				float3 lerpResult258_g994 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( saturate( ( FogDistanceMask12_g994 - 0.5 ) ) * AHF_FogColorDuo ));
				float3 normalizeResult318_g994 = normalize( ( WorldPosition2_g994 - _WorldSpaceCameraPos ) );
				float dotResult145_g994 = dot( normalizeResult318_g994 , AHF_DirectionalDir );
				float temp_output_140_0_g994 = ( (dotResult145_g994*0.5 + 0.5) * AHF_DirectionalIntensity );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch470_g994 = temp_output_140_0_g994;
				#else
				float staticSwitch470_g994 = pow( abs( temp_output_140_0_g994 ) , AHF_DirectionalFalloff );
				#endif
				float DirectionalMask30_g994 = staticSwitch470_g994;
				float3 lerpResult40_g994 = lerp( lerpResult258_g994 , (AHF_DirectionalColor).rgb , DirectionalMask30_g994);
				#ifdef AHF_DISABLE_DIRECTIONAL
				float3 staticSwitch442_g994 = lerpResult258_g994;
				#else
				float3 staticSwitch442_g994 = lerpResult40_g994;
				#endif
				float3 temp_output_2_0_g999 = staticSwitch442_g994;
				float3 gammaToLinear3_g999 = FastSRGBToLinear( temp_output_2_0_g999 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g999 = temp_output_2_0_g999;
				#else
				float3 staticSwitch1_g999 = gammaToLinear3_g999;
				#endif
				half3 Final_Color462_g994 = staticSwitch1_g999;
				half3 AHF_FogAxisOption181_g994 = AHF_FogAxisOption;
				float3 break159_g994 = ( WorldPosition2_g994 * AHF_FogAxisOption181_g994 );
				float temp_output_7_0_g995 = AHF_FogHeightEnd;
				float temp_output_167_0_g994 = saturate( ( ( ( break159_g994.x + break159_g994.y + break159_g994.z ) - temp_output_7_0_g995 ) / ( AHF_FogHeightStart - temp_output_7_0_g995 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch468_g994 = temp_output_167_0_g994;
				#else
				float staticSwitch468_g994 = pow( abs( temp_output_167_0_g994 ) , AHF_FogHeightFalloff );
				#endif
				half FogHeightMask16_g994 = staticSwitch468_g994;
				float lerpResult328_g994 = lerp( ( FogDistanceMask12_g994 * FogHeightMask16_g994 ) , saturate( ( FogDistanceMask12_g994 + FogHeightMask16_g994 ) ) , AHF_FogLayersMode);
				float mulTime204_g994 = _TimeParameters.x * 2.0;
				float3 temp_output_197_0_g994 = ( ( WorldPosition2_g994 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g994 ) );
				float3 p1_g998 = temp_output_197_0_g994;
				float localSimpleNoise3D1_g998 = SimpleNoise3D( p1_g998 );
				float temp_output_7_0_g997 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g994 = saturate( ( ( distance( WorldPosition2_g994 , _WorldSpaceCameraPos ) - temp_output_7_0_g997 ) / ( 0.0 - temp_output_7_0_g997 ) ) );
				float lerpResult198_g994 = lerp( 1.0 , (localSimpleNoise3D1_g998*0.5 + 0.5) , ( NoiseDistanceMask7_g994 * AHF_NoiseIntensity ));
				...
				#endif
				float temp_output_454_0_g994 = ( staticSwitch42_g994 * AHF_FogIntensity );
				...
				float temp_output_449_0_g994 = ( ( break170_g994.x + break170_g994.y + break170_g994.z ) + -AHF_SkyboxFogOffset );
				float temp_output_7_0_g996 = AHF_SkyboxFogHeight;
				float temp_output_176_0_g994 = saturate( ( ( abs( temp_output_449_0_g994 ) - temp_output_7_0_g996 ) / ( 0.0 - temp_output_7_0_g996 ) ) );
				float saferPower309_g994 = abs( temp_output_176_0_g994 );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch469_g994 = temp_output_176_0_g994;
				#else
				float staticSwitch469_g994 = pow( saferPower309_g994 , AHF_SkyboxFogFalloff );
				#endif
				float lerpResult179_g994 = lerp( saturate( ( staticSwitch469_g994 + ( AHF_SkyboxFogBottom * step( temp_output_449_0_g994 , 0.0 ) ) ) ) , 1.0 , AHF_SkyboxFogFill);
				half SkyboxFogHeightMask108_g994 = ( lerpResult179_g994 * AHF_SkyboxFogIntensity );
				float clampDepth338_g994 = SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy );
				#ifdef SHADER_API_GLES3
				float staticSwitch335_g994 = ( 1.0 - clampDepth338_g994 );
				#else
				float staticSwitch335_g994 = clampDepth338_g994;
				#endif
				half SkyboxFogMask95_g994 = ( 1.0 - ceil( staticSwitch335_g994 ) );
...
Node;AmplifyShaderEditor.FunctionNode;981;-3328,-4608;Inherit;False;Base;0;;994;13c50910e5b86de4097e1181ba121e0e;28,392,0,360,0,354,0,99,1,476,0,347,0,368,0,349,0,361,0,345,0,351,0,384,0,378,0,388,0,343,0,372,0,374,0,386,0,370,0,376,0,366,0,116,1,339,0,382,0,380,0,355,0,364,0,450,0;0;3;FLOAT4;113;FLOAT3;86;FLOAT;87
...
WireConnection;961;2;981;86
WireConnection;961;3;981;87
ASEEND*/
//CHKSM=0F068AAAF613FA3F2458AEEAFF6FFA0CA63DF58F